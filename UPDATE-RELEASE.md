...
version: 1.1.10
files:
  - url: BanHangOffline-Setup-v1.1.10.exe
    sha512: BASE64_SHA512
    size: 76845764
path: BanHangOffline-Setup-v1.1.10.exe
sha512: BASE64_SHA512
...
Sau đó tạo release/tag `v1.1.10` và upload các asset sau bằng GitHub UI hoặc GitHub CLI đã đăng nhập sẵn:

```cmd
gh release create v1.1.10 release/BanHangOffline-Setup-v1.1.10.exe release/BanHangOffline-Setup-v1.1.10.exe.blockmap release/latest.yml release/update-manifest.json --title "BanHangOffline v1.1.10" --generate-notes --latest
```
