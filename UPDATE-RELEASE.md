...
version: 1.2.3
files:
  - url: BanHangOffline-Setup-v1.2.3.exe
    sha512: BASE64_SHA512
    size: 76845764
path: BanHangOffline-Setup-v1.2.3.exe
sha512: BASE64_SHA512
...
Sau đó tạo release/tag `v1.2.3` và upload các asset sau bằng GitHub UI hoặc GitHub CLI đã đăng nhập sẵn:

```cmd
gh release create v1.2.3 release/BanHangOffline-Setup-v1.2.3.exe release/BanHangOffline-Setup-v1.2.3.exe.blockmap release/latest.yml release/update-manifest.json --title "BanHangOffline v1.2.3" --generate-notes --latest
```
