...
- installer `banhangoffline-setup-v1.3.4.exe`
- `banhangoffline-setup-v1.3.4.exe.blockmap`
- `latest.yml`
...
- Tag release theo version mới, ví dụ `v1.3.4`.
...
Sau đó tạo release/tag `v1.3.4` và upload các asset sau bằng GitHub UI hoặc GitHub CLI đã đăng nhập sẵn:

```cmd
gh release create v1.3.4 release/banhangoffline-setup-v1.3.4.exe release/banhangoffline-setup-v1.3.4.exe.blockmap release/latest.yml release/update-manifest.json --title "BanHangOffline v1.3.4" --generate-notes --latest
```
