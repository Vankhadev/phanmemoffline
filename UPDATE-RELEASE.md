...
version: 1.1.7
files:
  - url: BanHangOffline-Setup-v1.1.7.exe
    sha512: BASE64_SHA512
    size: 76845764
path: BanHangOffline-Setup-v1.1.7.exe
sha512: BASE64_SHA512
...
Sau đó tạo release/tag `v1.1.7` và upload các asset sau bằng GitHub UI hoặc GitHub CLI đã đăng nhập sẵn:

```cmd
gh release create v1.1.7 release/BanHangOffline-Setup-v1.1.7.exe release/BanHangOffline-Setup-v1.1.7.exe.blockmap release/latest.yml release/update-manifest.json --title "BanHangOffline v1.1.7" --generate-notes --latest
```
