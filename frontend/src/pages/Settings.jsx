...
const INITIAL_PRINT_TEMPLATE_FORM = Object.freeze({
  ...
  showSubtotal: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showSubtotal,
  showDiscount: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showDiscount,
  showDelivery: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showDelivery,
  showGrandTotal: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showGrandTotal,
  showOldDebt: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showOldDebt,
  showPayable: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showPayable,
  showPaid: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showPaid,
  showDebt: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showDebt,
  showChange: DEFAULT_INVOICE_TEMPLATE_SETTINGS.showChange,
...
function normalizePrintTemplateForm(payload = {}, fallbackStore = {}) {
  ...
  return {
    ...
    showSubtotal: Boolean(settings.showSubtotal),
    showDiscount: Boolean(settings.showDiscount),
    showDelivery: Boolean(settings.showDelivery),
    showGrandTotal: Boolean(settings.showGrandTotal),
    showOldDebt: Boolean(settings.showOldDebt),
    showPayable: Boolean(settings.showPayable),
    showPaid: Boolean(settings.showPaid),
    showDebt: Boolean(settings.showDebt),
    showChange: Boolean(settings.showChange),
...
function sanitizePrintTemplatePayload(form = {}) {
  ...
  const settingsInput = {
    ...
    showSubtotal: Boolean(form.showSubtotal),
    showDiscount: Boolean(form.showDiscount),
    showDelivery: Boolean(form.showDelivery),
    showGrandTotal: Boolean(form.showGrandTotal),
    showOldDebt: Boolean(form.showOldDebt),
    showPayable: Boolean(form.showPayable),
    showPaid: Boolean(form.showPaid),
    showDebt: Boolean(form.showDebt),
    showChange: Boolean(form.showChange),
