...
- `banhangoffline-setup-v1.3.8-x64.exe`: dùng cho Windows 64-bit.
- `banhangoffline-setup-v1.3.8-ia32.exe`: dùng cho Windows 32-bit hoặc khi máy báo không chạy được bản x64.
