...
- `banhangoffline-setup-v1.4.3-x64.exe`: dùng cho Windows 64-bit.
- `banhangoffline-setup-v1.4.3-ia32.exe`: dùng cho Windows 32-bit hoặc khi máy báo không chạy được bản x64.
